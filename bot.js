...
//nubstnubstnubstyhh
 ...
 client.on('message', message => {
    if (message.content === '!sgame' ) {
        ...
        .addField('1. Every player gets one nerf','___',false)
        .addField("2. If you cheat, you have to commit suicide and you'll get two new nerfs on the next game",'___',false)
        .addField('3. If you cheat when you have a team nerf, you (only) have to commit suicide and all the team members will get two new nerfs on the next game','___',false)
        .addField("4. Please play fair and try not to spam. If you've cheated, say it or we'll kick you",'___',false)
        .addField('5. Dont type other then !roll when game start on nerf_roll channel','___',false)
        message.channel.send(embed)
    }})
