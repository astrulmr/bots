...
client.on('message', message => {
  if (message.content == '!run'){          
      ...
      .setColor(0xFFFF00)
      .addField('Astru'," ",true)
      .addField('Kevin1185'," ",true)
      .addField('Jimm25'," ",true)
      .addField('SweetMiguel'," ",true)
      .addField('DanzoDon'," ",true)
      ...
      client.on('message', message => {
        if (message.content == '!sup'){          
            ...
            .setColor(0xFFFF00)
            .addField('Kenshiro'," ",true)
            .addField('|OS| Tmis Kun'," ",true)
            .addField('ThomaSerena'," ",true)
            .addField('PanosBOA'," ",true)
            .addField('LordCroissant'," ",true)
            ...
            client.on('message', message => {
              if (message.content == '!def'){          
                  ...
                  .setColor(0xFFFF00)
                  .addField('Styleken'," ",true)
                  .addField('KaeptnKook'," ",true)
                  .addField('Jinleehurb'," ",true)
                  .addField('Junusbiaz'," ",true)
                  .addField('BlueDragon'," ",true)
