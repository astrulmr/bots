...
client.on('message', message => {
 if(message.content == `!runners`) {
        const ListEmbed = new Discord.RichEmbed()
            ...
            .addField("Runners",message.guild.roles.get('730019439180775434').members.map(m=>m.user.username).join('**\n :traffic_light: :traffic_light: :traffic_light: \n**'),true)
            .addField("Supporters",message.guild.roles.get('730019439180775434').members.map(m=>m.user.username).join('\n :traffic_light: :traffic_light: :traffic_light: \n'),true)
            .addField("defeders",message.guild.roles.get('730019439180775434').members.map(m=>m.user.username).join('\n :traffic_light: :traffic_light: :traffic_light: \n'),true)
