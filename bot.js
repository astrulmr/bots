...
client.on('message', message => {
 ...
 client.on('message', message => {
     if (message.content == '!defender'){          
         ...
         .addField(`${pugMemberss.username}`,`${pugMemberss[4]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[5]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[6]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[7]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[8]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[9]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[10]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[11]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[12]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[13]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[14]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[15]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[16]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[17]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[18]}`,true)
         .addField(`${pugMemberss.username}`,`${pugMemberss[19]}`,true)
