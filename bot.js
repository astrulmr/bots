      ...
      client.on("message", message => {
          if (message.content === '!socialmedia') {
              let embed = new RichEmbed()
                .setTitle('Youtube')
                .setColor('0xc4302b')
                .setThumbnail('https://news.bitcoin.com/wp-content/uploads/2015/10/flat_youtube_wallpaper_by_oscagapotes-d6o637w.png')
      ...
      client.on("message", message => {
          if (message.content === '!socialmedia') {
              let embed = new RichEmbed()
                .setTitle('Twitter')
                .setColor('0x00acee')
                .setThumbnail('https://gymnasieskolen.dk/sites/default/files/Undervisning/twitter-logo-whiteonblue.jpg')
