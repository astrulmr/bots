      ...
      client.on("message", message => {
          if (message.content === '!socialmedia') {
              let embed = new RichEmbed()
                .setTitle('Discord')
                .setColor('0x7289d9')
                .setThumbnail('https://img.pngio.com/transparent-discord-icon-227118-free-icons-library-discord-logo-transparent-background-245_250.jpg')
