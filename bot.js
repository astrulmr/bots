...
client.on('message', message => {
  if (message.content == '!codes'){          
      ...
      .addField('!legends                        _________________________ ',"To see every one fav legend in the server",true)
      .addField('! @anyname                     _________________________ ',"To see fav legend of someone in the server",true)
      .addField('!pall                             _________________________    ',"To see all runners and supporters and defender in the server",true)
      .addField('!run                                _________________________',"To see all runners the server        \n ",false)

      .addField('!sup                               _________________________',"To see all supporters in the server          ",false)

      .addField('!def                                _________________________',"To see all defenders in the server",false)
      .addField('!ap                                  _________________________',"To see which position and clan of every one in the server",true)
      .addField("!colors                               _________________________","To see all color that can change ur name color",true)
