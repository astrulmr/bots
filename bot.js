      ...
      client.on("message", message => {
          if (message.content === '!socialmedia') {
              let embed = new RichEmbed()
                .setTitle('Youtube')
                .setColor('0xc4302b')
                .setThumbnail('https://9to5mac.com/wp-content/uploads/sites/6/2017/08/youtube_logo_dark.jpg?quality=82&strip=all')
      ...
      client.on("message", message => {
          if (message.content === '!socialmedia') {
              let embed = new RichEmbed()
                .setTitle('Twitter')
                .setColor('0x00acee')
                .setThumbnail('https://cdn57.androidauthority.net/wp-content/uploads/2019/01/Twitter-Dark-Mode.jpg')
      ...
      client.on("message", message => {
          if (message.content === '!socialmedia') {
              let embed = new RichEmbed()
                .setTitle('Twitch')
                .setColor('0x6441a5')
                .setThumbnail('https://i.pinimg.com/originals/8c/34/94/8c3494b88baa641b914ec8b236e3aa02.jpg')
      ...
      client.on("message", message => {
          if (message.content === '!socialmedia') {
              let embed = new RichEmbed()
                .setTitle('Reddit')
                .setColor('0xFF4301')
                .setThumbnail('https://rdwgroup.com/wp-content/uploads/2018/10/reddit2-800x450-1.png')
